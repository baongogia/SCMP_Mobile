                                  ...
                                  <View
                                    style={[
                                      styles.textInputContainer,
                                      {
                                        ...
                                        borderRadius: 12,
                                        marginHorizontal: -12, // Bleed background
                                        paddingHorizontal: 12, // Push text back to alignment
                                        paddingVertical: 12,
                                        borderBottomWidth: 1, // Faint underline
                                    ...
                                    <TextInput
                                      style={[
                                        styles.textInput,
                                        {
                                          ...
                                          fontSize: 15,
                                          color: colors.text,
                                          paddingHorizontal: 0, // Align text with Title
                                          paddingVertical: 0,
                                        },
                                      ]}
                                      multiline
