...
const attendanceData = [
  { id: '1', date: '15/08/2023', dayOfWeek: 'Thứ Ba', checkIn: '07:45', checkOut: '17:05', status: 'Đúng giờ' },
  { id: '2', date: '16/08/2023', dayOfWeek: 'Thứ Tư', checkIn: '07:55', checkOut: '17:10', status: 'Đúng giờ' },
  { id: '3', date: '17/08/2023', dayOfWeek: 'Thứ Năm', checkIn: '08:10', checkOut: '17:00', status: 'Đi muộn' },
  { id: '4', date: '18/08/2023', dayOfWeek: 'Thứ Sáu', checkIn: '07:30', checkOut: '16:45', status: 'Đúng giờ' },
  { id: '5', date: '19/08/2023', dayOfWeek: 'Thứ Bảy', checkIn: '--:--', checkOut: '--:--', status: 'Nghỉ' },
  { id: '6', date: '20/08/2023', dayOfWeek: 'Chủ Nhật', checkIn: '--:--', checkOut: '--:--', status: 'Nghỉ' },
  { id: '7', date: '21/08/2023', dayOfWeek: 'Thứ Hai', checkIn: '07:50', checkOut: '17:15', status: 'Đúng giờ' },
];
...
export function AttendanceReportPopup() {
  ...
  const presentDays = attendanceData.filter(item => item.status !== 'Nghỉ').length;
  const lateDays = attendanceData.filter(item => item.status === 'Đi muộn').length;
    ...
    <>
      ...
      <View style={styles.filterContainer}>
        ...
        <View style={styles.filterOptions}>
          <TouchableOpacity 
            style={[styles.filterOption, filterStatus === 'Tất cả' && styles.activeFilter]}
            onPress={() => setFilterStatus('Tất cả')}
          >
            <ThemedText style={filterStatus === 'Tất cả' ? styles.activeFilterText : {}}>Tất cả</ThemedText>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.filterOption, filterStatus === 'Đi muộn' && styles.activeFilter]}
            onPress={() => setFilterStatus('Đi muộn')}
          >
            <ThemedText style={filterStatus === 'Đi muộn' ? styles.activeFilterText : {}}>Đi muộn</ThemedText>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.filterOption, filterStatus === 'Nghỉ' && styles.activeFilter]}
            onPress={() => setFilterStatus('Nghỉ')}
          >
            <ThemedText style={filterStatus === 'Nghỉ' ? styles.activeFilterText : {}}>Nghỉ</ThemedText>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <ThemedView style={styles.tableHeader}>
        ...
        <ThemedText style={[styles.headerText, { flex: 2 }]}>Giờ làm việc</ThemedText>
        <ThemedText style={[styles.headerText, { flex: 1 }]}>Trạng thái</ThemedText>
      </ThemedView>
    </>
  );
  ...
  const renderFooter = () => (
    <TouchableOpacity style={styles.downloadButton}>
      <ThemedText style={styles.downloadButtonText}>Tải xuống báo cáo</ThemedText>
    </TouchableOpacity>
  );
