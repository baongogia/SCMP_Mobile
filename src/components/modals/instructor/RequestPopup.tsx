...
export function RequestPopup() {
  const [requestType, setRequestType] = useState('leave'); // 'leave' or 'other'
  ...
  const renderRequestTypeSelector = () => (
    <View style={styles.formGroup}>
      ...
      >
        <ThemedText>{requestType === 'leave' ? 'Đơn xin nghỉ phép' : 'Đơn khác'}</ThemedText>
      </TouchableOpacity>
      ...
      >
        ...
        >
          <View style={styles.modalView}>
            ...
            >
              <ThemedText style={styles.optionText}>Đơn xin nghỉ phép</ThemedText>
            </TouchableOpacity>
  ...
  return (
    <PopupBase title={requestType === 'leave' ? "Đơn xin nghỉ phép" : "Đơn khác"}>
