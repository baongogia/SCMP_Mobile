...
export function NoteClassSelectionScreen() {
  ...
  // Handle class selection - navigate to NoteScreen
  ...
  return (
    ...
    >
      <SharedHeader title="Ghi chú" />

      {/* Content */}
      <View style={styles.content}>
        <Text style={styles.listTitle}>
          Chọn lớp học để xem ghi chú:
        </Text>
