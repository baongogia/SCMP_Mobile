    ...
    const offNavigateChat = eventBus.on("navigate:chat", (data: any) => {
      ...
      if (data.roomId) {
        ...
        const targetGroup = chatGroups.find((group) => {
          console.log("[Member Chat] Comparing:", {
            groupId: group.id,
            roomId: data.roomId,
        ...
        if (targetGroup) {
          console.log("[Member Chat] Found target group:", {
            id: targetGroup.id,
          ...
          console.log(
            "[Member Chat] Target group not found, refreshing chat groups"
          );
          ...
          fetchChatGroups().then(() => {
            ...
            if (updatedTargetGroup) {
              console.log("[Member Chat] Found target group after refresh:", {
              ...
              console.log("[Member Chat] Still not found after refresh");
            }
          });
        }
      }
    ...
    try {
      ...
      try {
        ...
        if (Array.isArray(allChannels)) {
          ...
          // Fetch newest message for each class
          try {
        ...
        <View style={styles.inputRow}>
          ...
          <TextInput
            ...
            onChangeText={(text) => {
              ...
              console.log("[Member Chat] TextInput onChangeText:", {
              ...
              if (selectedGroup?.id && text.trim()) {
                console.log(
                  "[Member Chat] Starting typing for group:",
                  selectedGroup.id
                );
                // Start typing
                ...
                typingTimeoutRef.current = setTimeout(() => {
                  if (selectedGroup?.id) {
                    console.log(
                      "[Member Chat] Auto-stopping typing for group:",
                      selectedGroup.id
                    );
                ...
                console.log(
                  "[Member Chat] Stopping typing (empty text) for group:",
                  selectedGroup.id
                );
